...
public abstract class WebServer{
	...
	protected Session init(WebServerCommand command){
	...
	public abstract Response process( Session session, Command command ) throws Exception;
	
	public Response process( WebServerCommand command ) throws Exception{
