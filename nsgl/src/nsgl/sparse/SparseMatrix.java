...
import nsgl.collection.Indexed;
import nsgl.exception.NoSuchElement;
import nsgl.sparse.array.matrix.SparseMatrixElement;
import nsgl.sparse.array.matrix.SparseMatrixElementsIterator;
import nsgl.sparse.array.matrix.SparseMatrixIndicesIterator;
import nsgl.sparse.array.matrix.SparseMatrixIterator;
 ...
 * @version 1.0
 */
public class SparseMatrix<T> implements Indexed<int[],T>{
	/**
	 ...
	 * @param column Number of column
	 */
	public T get(int[] pos) { return get(pos, 0); }
	
	public T obtain(int[] pos) throws NoSuchElementException{
		T x = get(pos);
		if(x!=null) return x;
	...
	@Override
	public boolean add(int[] pos, T value) { return set(pos, value); }

	public T data(){ return data; }

	public SparseArray<SparseMatrix<T>>[] dim_data(){ return dimension_data; }
