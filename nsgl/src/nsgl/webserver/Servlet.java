...
public class Servlet extends HttpServlet{
	...
	public Servlet( WebServer server ){ this.server = server; }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		try{
			WebServerCommand cmd = new WebServerCommand(request.getHeader("object"), request.getHeader("method"), request.getInputStream());
